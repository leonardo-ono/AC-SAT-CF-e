...
/*     */ 
/*     */ public class JanelaICMSSN900 extends JDialog
/*     */ {
...
/*     */   public String CSOSN;
/*     */ 
/*     */   public JanelaICMSSN900(JDialog owner, String CSOSN)
/*     */   {
/*  41 */     super(owner);
/*  42 */     initialize();
/*  43 */     this.CSOSN = CSOSN;
...
/*     */         {
/* 141 */           JanelaICMSSN900.this.ok = true;
/* 142 */           JanelaICMSSN900.this.aliq = JanelaICMSSN900.this.textoAliquota.getText();
/* 143 */           JanelaICMSSN900.this.orig = JanelaICMSSN900.this.textoOrigem.getText();
/* 144 */           if (JanelaICMSSN900.this.orig.equals(""))
/*     */           {
/* 146 */             JOptionPane.showMessageDialog(JanelaICMSSN900.this, "O Campo \"Origem da mercadoria\" é de preenchimento obrigatório!");
/* 147 */             return;
/*     */           }
/* 149 */           if (JanelaICMSSN900.this.aliq.equals(""))
/*     */           {
/* 151 */             JOptionPane.showMessageDialog(JanelaICMSSN900.this, "O Campo \"Alíquota efetiva\" é de preenchimento obrigatório!");
/* 152 */             return;
/*     */           }
/*     */ 
/* 156 */           JanelaICMSSN900.this.dispose();
/*     */         }
/*     */       });
/*     */     }
/*     */ 
...
/*     */         {
/* 180 */           JanelaICMSSN900.this.ok = false;
/* 181 */           JanelaICMSSN900.this.dispose();
/*     */         }
/*     */       });
/*     */     }
 ...
 * Qualified Name:     br.com.pirus.ac.interfaces.JanelaICMSSN900
