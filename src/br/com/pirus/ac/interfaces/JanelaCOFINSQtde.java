...
/*     */ 
/*     */ public class JanelaCOFINSQtde extends JDialog
/*     */ {
...
/*     */ 
/* 189 */   public String aliq = "";
/*     */ 
/* 191 */   public String CST = "";
/*     */ 
/*     */   public JanelaCOFINSQtde(JDialog owner)
/*     */   {
/*  41 */     super(owner);
/*  42 */     initialize();
/*     */   }
...
/*  78 */       this.labelAliquota.setText("Aliquota em reais");
...
/*     */         {
/* 140 */           JanelaCOFINSQtde.this.ok = true;
/* 141 */           JanelaCOFINSQtde.this.aliq = JanelaCOFINSQtde.this.textoAliquota.getText();
/* 142 */           JanelaCOFINSQtde.this.CST = JanelaCOFINSQtde.this.textoCST.getText();
/* 143 */           if (JanelaCOFINSQtde.this.CST.equals(""))
/*     */           {
/* 145 */             JOptionPane.showMessageDialog(JanelaCOFINSQtde.this, "O Campo \"Código de Situação Tributária\" é de preenchimento obrigatório!");
/* 146 */             return;
/*     */           }
/* 148 */           if (JanelaCOFINSQtde.this.aliq.equals(""))
/*     */           {
/* 150 */             JOptionPane.showMessageDialog(JanelaCOFINSQtde.this, "O Campo \"Alíquota em reais\" é de preenchimento obrigatório!");
/* 151 */             return;
/*     */           }
/*     */ 
/* 155 */           JanelaCOFINSQtde.this.dispose();
/*     */         }
/*     */       });
/*     */     }
/*     */ 
...
/*     */         {
/* 179 */           JanelaCOFINSQtde.this.ok = false;
/* 180 */           JanelaCOFINSQtde.this.dispose();
/*     */         }
/*     */       });
/*     */     }
 ...
 * Qualified Name:     br.com.pirus.ac.interfaces.JanelaCOFINSQtde
