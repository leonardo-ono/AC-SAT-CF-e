...
/*     */ 
/*     */ public class JanelaCOFINSNT extends JDialog
/*     */ {
...
/*     */   public String CST;
/*     */ 
/*     */   public JanelaCOFINSNT(JDialog owner)
/*     */   {
/*  37 */     super(owner);
/*  38 */     initialize();
/*     */   }
...
/*     */         {
/* 116 */           JanelaCOFINSNT.this.ok = true;
/* 117 */           JanelaCOFINSNT.this.CST = JanelaCOFINSNT.this.textoCST.getText();
/* 118 */           if (JanelaCOFINSNT.this.CST.equals(""))
/*     */           {
/* 120 */             JOptionPane.showMessageDialog(JanelaCOFINSNT.this, "O Campo \"Código de Situação Tributária\" é de preenchimento obrigatório!");
/* 121 */             return;
/*     */           }
/*     */ 
/* 125 */           JanelaCOFINSNT.this.dispose();
/*     */         }
/*     */       });
/*     */     }
/*     */ 
...
/*     */         {
/* 149 */           JanelaCOFINSNT.this.ok = false;
/* 150 */           JanelaCOFINSNT.this.dispose();
/*     */         }
/*     */       });
/*     */     }
 ...
 * Qualified Name:     br.com.pirus.ac.interfaces.JanelaCOFINSNT
