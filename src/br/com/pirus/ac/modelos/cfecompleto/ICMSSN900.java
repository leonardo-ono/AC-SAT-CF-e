...
/*     */ {
/* 180 */   private String orig = null;
/*     */ 
/* 183 */   private String CSOSN = null;
/*     */ 
/* 186 */   private String pICMS = null;
/*     */ 
/* 189 */   private String vICMS = null;
/*     */ 
...
/*     */       }
/*  53 */       else if (filhoAtual.getNodeName().equalsIgnoreCase("CSOSN"))
/*     */       {
/*  55 */         this.CSOSN = filhoAtual.getTextContent();
/*     */       }
...
/* 145 */       resultado = "1471";
/*     */     }
/* 147 */     else if (!this.CSOSN.equals("900"))
/*     */     {
/* 149 */       resultado = "1477";
/*     */     }
...
/* 166 */     if (this.CSOSN != null)
/* 167 */       retorno.append("<CSOSN>").append(this.CSOSN).append("</CSOSN>");
 ...
 * Qualified Name:     br.com.pirus.ac.modelos.cfecompleto.ICMSSN900
